...
var editConfigCmd = &cobra.Command{
	...
	Short:   "edit Wove configuration files",
	Long:    "Edit Wove configuration files. Defaults to settings.json if no file specified. Common files: settings.json, presets.json, widgets.json",
