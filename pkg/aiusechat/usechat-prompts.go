...
IMPORTANT: NEVER use sed, awk, or other terminal commands to edit files. ALWAYS use edit_text_file for modifications and write_text_file for creating files. These tools create backups, show diffs, and enforce read-before-write. Using sed bypasses all safety checks.
