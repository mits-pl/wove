...
func GetWebCaptureToolDefinition(tabId string) uctypes.ToolDefinition {
	return uctypes.ToolDefinition{
		...
		ToolImageTextCallback: func(input any) (string, string, error) {
			inputMap, ok := input.(map[string]any)
			if !ok {
			...
			// Build text output with viewport info and element list
