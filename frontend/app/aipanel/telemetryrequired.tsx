                    ...
                    <div className="bg-blue-900/20 border border-blue-500 rounded-lg p-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="text-left">
                                <div className="text-blue-400 font-medium mb-1">Telemetry keeps Wove AI free</div>
                                <div className="text-secondary text-sm mb-3">
                                    <p className="mb-2">
                                        To keep Wove AI free for everyone, we require a small amount of <i>anonymous</i>{" "}
                                    ...
                                    <p className="mb-2">
                                        ...
                                        identifying information. Wove AI is powered by OpenAI's APIs, please refer to
