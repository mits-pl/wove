...
export class TermViewModel implements ViewModel {
    ...
    getShellIntegrationIconButton(get: jotai.Getter): IconButtonDecl | null {
        ...
        if (shellIntegrationStatus === "running-command") {
            let title = "Shell busy — Wove AI unable to run commands while another command is running.";
            ...
            if (this.termRef.current) {
                ...
                if (blockingCmd) {
                    title = `Wove AI integration disabled while you're inside ${blockingCmd}.`;
                }
            }
