    ...
    return (
        <div className="flex flex-col items-start gap-6 w-full mb-4 unselectable">
            <div className="text-secondary leading-relaxed">
                <p className="mb-0">
                    Wove AI can now create and modify files with visual diff previews and easy rollback capabilities.
            ...
            <div className="flex w-full items-start gap-4">
                ...
                <div className="flex flex-col items-start gap-2 flex-1">
                    <div className="text-foreground text-base font-semibold leading-[18px]">Wove AI File Editing</div>
                    <div className="text-secondary leading-5">
                        <ul className="list-disc list-outside space-y-1 pl-5">
                            <li>
                                <strong>File Write Tool</strong> - Wove AI can now create and modify files with your
                                approval
                            </li>
                            <li>
            ...
            <div className="flex w-full items-start gap-4">
                ...
                <div className="flex flex-col items-start gap-2 flex-1">
                    ...
                    <div className="text-secondary leading-5">
                        <ul className="list-disc list-outside space-y-1 pl-5">
                            <li>Drag & drop files from preview viewer directly to Wove AI</li>
                            <li>
