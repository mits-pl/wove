    ...
    return (
        <div className="flex flex-col items-start gap-6 w-full mb-4 unselectable">
                ...
                <div className="flex flex-col items-start gap-2 flex-1">
                    ...
                    <div className="text-secondary leading-5">
                        <ul className="list-disc list-outside space-y-1 pl-5">
                            ...
                            <li>
                                <strong>Updated Focus Keybinding</strong> - Wove AI focus key changed to Alt:0 on
                                Windows
                            </li>
                        </ul>
                    </div>
            ...
            <div className="flex w-full items-start gap-4">
                ...
                <div className="flex flex-col items-start gap-2 flex-1">
                    <div className="text-foreground text-base font-semibold leading-[18px]">Wove AI Updates</div>
                    <div className="text-secondary leading-5">
                        <ul className="list-disc list-outside space-y-1 pl-5">
                            <li>
                            ...
                            <li>
                                <strong>BYOK Without Telemetry</strong> - Wove AI now works with bring-your-own-key and
